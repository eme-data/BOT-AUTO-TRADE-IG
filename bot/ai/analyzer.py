...
class ClaudeAnalyzer:
    ...
    def is_enabled(self) -> bool:
        return bool(settings.ai.enabled and settings.ai.api_key)
    ...
    def _is_mode_enabled(self, mode: AnalysisMode) -> bool:
        mode_flags = {
            AnalysisMode.PRE_TRADE: settings.ai.pre_trade_enabled,
            AnalysisMode.MARKET_REVIEW: settings.ai.market_review_enabled,
            AnalysisMode.SENTIMENT: settings.ai.sentiment_enabled,
            AnalysisMode.POST_TRADE: settings.ai.post_trade_enabled,
        }
