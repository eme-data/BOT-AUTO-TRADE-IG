...
export default function UserManagement() {
  ...
  const inputClass = 'w-full bg-bg-primary border border-gray-600 rounded px-3 py-2 text-white text-sm'
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-bg-card rounded-lg border border-gray-700 p-6">
        <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider mb-4">Admin Users</h2>
        <div className="space-y-2">
          {users.map((u) => (
            <div key={u.id} className="flex items-center justify-between py-2 px-3 rounded bg-bg-primary">
              <div>
      ...
      {/* Add new user */}
      <div className="bg-bg-card rounded-lg border border-gray-700 p-6">
        <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider mb-4">Add New User</h2>
      ...
      {/* Change my password */}
      <div className="bg-bg-card rounded-lg border border-gray-700 p-6">
        <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider mb-4">Change My Password</h2>
