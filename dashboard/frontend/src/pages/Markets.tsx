  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card p-6">
        <h3 className="section-title mb-3">Search IG Markets</h3>
        ...
        {searchResults.length > 0 && (
          <div className="mt-4 overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {searchResults.map((r) => (
                  <tr key={r.epic} className="border-b border-border/50 hover:bg-bg-hover/50 transition-colors">
                    <td className="px-3 py-2">
                      <div className="font-medium">{r.instrument_name}</div>
                      <div className="text-xs text-gray-500">{r.epic}</div>
                    </td>
                    <td className="px-3 py-2 text-gray-500">{r.instrument_type}</td>
            ...
            {watched.map((m) => (
              <div
                ...
                className={`flex items-center justify-between p-3 rounded-lg border ${
                  m.enabled ? 'border-border' : 'border-border/50 opacity-50'
                }`}
              >
                <div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={
                      m.enabled
                        ? 'badge-profit cursor-pointer hover:bg-profit/30'
                        : 'badge-neutral cursor-pointer hover:bg-bg-hover/80'
                    }
                  >
